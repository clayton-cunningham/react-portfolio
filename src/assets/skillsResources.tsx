...
export const software = [
  {name: "Git", value: 3},
  {name: ".NET", value: 3},
  {name: "AWS Lambda", value: 4},
  {name: "AWS S3", value: 4},
  {name: "AWS DynamoDB", value: 4},
  {name: "AWS Cloudwatch", value: 2},
  {name: "AWS IAM", value: 2},
  {name: "Kubernetes", value: 4},
  {name: "Docker", value: 2},
  {name: "Terraform", value: 3},
  {name: "Kafka", value: 2},
  {name: "Eclipse", value: 2},
  {name: "Visual Studio", value: 2},
  {name: "Datadog", value: 3},
  {name: "Snowflake", value: 3},
  {name: "Jest", value: 3},
  {name: "Cypress", value: 3},
  {name: "K6", value: 3},
  {name: "Rest API's", value: 3},
  {name: ".", value: 1},
]
